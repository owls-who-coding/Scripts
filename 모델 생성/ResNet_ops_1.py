...
from keras.layers import LSTM, TimeDistributed, Reshape, Flatten, GlobalAveragePooling2D, MaxPooling2D, MaxPooling1D, MaxPooling3D,GlobalAveragePooling1D, GlobalAveragePooling3D
...
class Load_model:
    ...
    def build_network(self):
        ...
        # lstm = Sequential()
        # lstm.add(LSTM(units=128, input_shape=(10,20)))
        # lstm.add(Dense(units=10, activation = 'softmax'))
